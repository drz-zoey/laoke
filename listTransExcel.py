...
input_file = path + "\\example_test.txt"
...
with open(input_file, 'r' , encoding='utf-8') as f:
    ...
    for line in f:
        ...
        #根据单品名称匹配品牌
        brand_match_skii = re.search(r"(SK2|sk2|skii|sk-ii|skll|眼面套|神灯套|小灯泡|神仙水|大红瓶|前男友|甄选三件套|增选3件套)", line)
        ...
        brand_match_lk = re.search(r"(小白管|菁纯|小黑瓶|发光眼霜|肌底液|雪花霜|粉水|极光|持妆|是我|三件套带水|带水三件套|小蛮腰)", line)
        brand_match_kys = re.search(r"(金盏花|宝宝霜|高保湿|白泥|紫波A面霜|爱海南三件套)", line)
        ...
        brand_match_ysl = re.search(r"(圣罗兰|YSL|ysl|Ysl|夜皇后|藏金|粉气垫|皮气垫|小金条|小黑条|小粉条)", line)
